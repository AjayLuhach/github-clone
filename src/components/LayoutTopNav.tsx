          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <div className="relative hidden sm:block">
              <button
                ...
                onMouseLeave={() => setShowTooltip(null)}
                className="flex items-center gap-1 text-muted hover:text-white hover:bg-btnHover border border-line rounded-md transition-colors"
                aria-label={nav.copilot}
              >
                <div className="border-r-muted border-r-[0.10rem] p-2">
                  <CopilotIcon />
                </div>
                <div className="p-2">
            ...
            <div className="relative shrink-0">
              <button
                ...
                onMouseLeave={() => setShowTooltip(null)}
                className="flex items-center gap-1 p-2 text-muted hover:text-white hover:bg-btnHover border border-line rounded-md transition-colors"
              ...
              {showTooltip === 'create' && (
                <div className="absolute top-full right-0 mt-2 px-2 py-1 bg-subtle text-xs text-white rounded shadow-lg whitespace-nowrap z-50 border border-line">
                  {nav.create}
                </div>
              )}
            </div>
            ...
            <div className="relative hidden md:block">
              <button
                ...
                onMouseLeave={() => setShowTooltip(null)}
                className="p-2 text-muted hover:text-white hover:bg-btnHover border border-line rounded-md transition-colors"
            ...
            <div className="relative shrink-0">
              <button
                ...
                onMouseLeave={() => setShowTooltip(null)}
                className="relative p-2 text-muted hover:text-white hover:bg-btnHover border border-line rounded-md transition-colors"
              ...
              >
                ...
                <span className="absolute top-1 right-1 block h-2 w-2 rounded-full bg-accent ring-1 ring-insetBg"></span>
              </button>
            ...
            <div className="relative shrink-0">
              <button
                ...
                onMouseLeave={() => setShowTooltip(null)}
                className="flex items-center gap-1 hover:bg-btnHover rounded-full transition-colors"
